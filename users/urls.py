...
from .views import (
    ...
    LoginWithCodeView,
    ManageUserView,
    ListPilgrimsView, GetSupervisorView, GetLinkedPilgrimView, InactiveEmergencyProfilesView,
)
...
urlpatterns = [
    ...
    path('emergency-profiles/inactive/', InactiveEmergencyProfilesView.as_view(), name='inactive_emergency_profiles'),
